...
(function (global, factory) {
    ...
    jgrid.extend({
        ...
        columnChooser: function (opts) {
                ...
                dlog_opts: function (options) {
                    ...
                    return $.extend(true, {
                        ...
                        resize: function () {
                            ...
                            $thisDialogContent.css("zIndex", 2);// 添加显示优先级 liuxk 2017/8/8
            ...
            $dialogContent.css({ margin: "auto", zIndex: 2 }); // 添加显示优先级 liuxk 2017/8/8
            ...
            var pNode = $dialogContent[0] ? $dialogContent[0].parentNode : null;
            if (pNode) {
                // 提高dialog显示优先级 liuxk 2017/8/8
                var iframe = "<iframe scrolling=no allowTransparency='true' style='background-color: transparent; position: absolute; z-index: 0; width: 100%; height: 100%; top: 0; left: 0; border: none;'></iframe>";
                $(iframe).appendTo(pNode);
            }
        },
