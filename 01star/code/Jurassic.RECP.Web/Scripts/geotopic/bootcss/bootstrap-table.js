...
!function ($) {
    ...
    BootstrapTable.LOCALES['en-US'] = {
        ...
        formatRecordsPerPage: function (pageNumber) {
            return sprintf('%s' + S_CM_Text_Paging5, pageNumber);
        },
        formatShowingRows: function (pageFrom, pageTo, totalRows) {
            return sprintf(S_CM_Text_Paging1 + ' %s' + S_CM_Text_Paging2 + ' %s ' + S_CM_Text_Paging3 + ' %s ' + S_CM_Text_Paging4, pageFrom, pageTo, totalRows);
        },
        formatSearch: function () {
            return S_C_Button_Search;
        },
